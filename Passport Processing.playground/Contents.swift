...
var input = Passport.generatePassportArray(list)
...
struct Passport {
    ...
    static func generatePassportArray(_ input: [String]) -> [String] {
...
func validPassportsPassOne() {
    let validPassports = passports.filter { $0.isValid() }
    
    print("Valid Passports = \(validPassports.count)")
}

validPassportsPassOne()
...
func validPassportsPassTwo() {
    let validPassports = passports.filter { $0.isDeepScanValid() }
    
    print("Valid Deep Scan Passports = \(validPassports.count)")
}

validPassportsPassTwo()
